...
if (isset($_POST['page']) && !empty($_POST['page'])) {
    if ($_POST['page'] == "submit_cart") {
        ...
        if (mysql_num_rows($vpb_check_items) < 1) {
            ...
            ?>
            <div id="vpb_shopping_cart_is_currently_empty" class="infobox-blue" align="left">
        ...
        if (isset($_POST['item_name']) && !empty($_POST['item_name']) && isset($_POST['item_price']) && !empty($_POST['item_price'])) {
            ...
            if (mysql_num_rows($vpb_check_items) < 1) {
                ...
                if (mysql_num_rows($vpb_check_all_items) < 1) {
                    ...
                    ?>
                    <div id="vpb_shopping_cart_is_currently_empty" class="well" align="left">
                        No data is passed at the moment. Please try again or contact the site admin to report this error message if the problem persist.<br /><br />Thanks You...
                    </div>
                    <?php
                }
            }
